...
class ShopForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['delivery_policy'].help_text = '( لطفا شیوه ارسال کالا را با مشتریان خود توضیح دهید. همچنین زمان تفریبی ارسال کالا. چنانچه ارسال کالا فقط از طریق پیک انجام می دهید و هزینه آن بر عهده مشتری می باشد, سیاست کاری خود را وارد کنید.)'
